...
wx_top_builddir="/Users/mploux/dev/pisine_cpp/Monitor/dep/wxWidgets"
top_srcdir="../.."
flags="-D_FILE_OFFSET_BITS=64 -I${wx_top_builddir}/lib/wx/include/osx_cocoa-unicode-3.1 -I${top_srcdir}/include -O2 -fno-common -fvisibility=hidden -fvisibility-inlines-hidden"
