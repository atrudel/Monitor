...
//     virtual const std::map<std::string, float> &getGraphsMin(void) const = 0;
//     virtual const std::map<std::string, float> &getGraphsMax(void) const = 0;
...
//   virtual std::map<std::string, std::deque<float> > getGraphs(void) const = 0;
